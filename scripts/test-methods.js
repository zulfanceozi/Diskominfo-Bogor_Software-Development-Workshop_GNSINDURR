...
async function testMethods() {
  ...
  // Test 1: Test POST method
  try {
    console.log('1️⃣ Testing POST /api/submissions...');
    const testData = {
      nama: "Test User Methods",
  ...
  // Test 2: Test GET method (should return 405)
  try {
    console.log('2️⃣ Testing GET /api/submissions (should fail)...');
  ...
  // Test 4: Test PATCH method (need a valid submission ID)
  try {
    console.log('4️⃣ Testing PATCH /api/admin/submissions/[id]/status...');
  ...
  console.log('🏁 Method testing completed!');
}
